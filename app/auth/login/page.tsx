...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-gray-800 p-4 bg-linear-to-br from-cyan-200 via-blue-200 to-teal-200">
      <div className="w-full max-w-md rounded-xl p-8 border border-white/20 bg-white/10 backdrop-blur-lg shadow-xl">

        <h2 className="text-2xl font-bold text-center mb-6 text-blue-600">
          {step === 'INPUT_PHONE' ? 'Login to your Account' : 'Verify Otp'}
        </h2>
        ...
        {step === 'VERIFY_OTP' && (
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className={`w-full py-2.5 rounded-lg text-white font-semibold transition-colors ${
                loading || !otpBtn ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'
              }`}
            >

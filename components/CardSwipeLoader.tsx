export default function CardSwipeLoader() {
  return (
    <div className="flex flex-col items-center justify-center min-h-40 bg-blue-100 rounded-xl">
      {/* Container / Terminal Slot */}
      <div className="relative flex items-center justify-center">
        {/* The Card */}
        {/* We use specific animation delays and translation to mimic the swipe */}
        <div className="z-10 w-16 h-10 bg-linear-to-br from-indigo-500 to-blue-600 rounded-md shadow-lg border border-indigo-400 relative animate-[bounce_1s_infinite]">
          {/* Card Chip */}
      ...
      <div className="mt-6 text-sm font-medium text-blue-500 animate-pulse">
        Processing Payment...
      </div>
    </div>
  );
